...
"""All models needed for LayerNoiseModel (Estimator version)"""
...
from ibm_quantum_schemas.common.version_0_1.typed_qpy_circuit import TypedQpyCircuitModel
...
class PauliListMetadataWrapperModel(BaseModel):
    ...
    value_: PauliListMetadataModel = Field(alias="__value__")
    """The actual data."""
...
class PauliLindbladErrorMetadataWrapperModel(BaseModel):
    ...
    value_: PauliLindbladErrorMetadataModel = Field(alias="__value__")
    """The actual data."""
...
class LayerNoiseModelMetadataWrapperModel(BaseModel):
    ...
    value_: LayerNoiseModelMetadataModel = Field(alias="__value__")
    """The actual data."""
