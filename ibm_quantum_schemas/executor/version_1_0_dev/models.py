...
class QuantumProgramModel(BaseModel):
    ...
    meas_level: Literal["classified", "kerneled", "avg_kerneled", "combined"] = "classified"
    ...
    into bits or not.
     ...
     - "avg_kerneled": Classical register data is returned as a complex array with the intrinsic
         ...
         over shots.
     - "combined": Both classified and kerneled data is returned for every classical register.
    """
