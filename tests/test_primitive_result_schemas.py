...
class TestEstimatorV2ResultSchema(unittest.TestCase):
    ...
    def setUp(self) -> None:
        with open(os.path.join(SCHEMAS_PATH, "estimator_result_v2_schema.json"), "r") as fd:
            self.estimator_schema = json.load(fd)
        self.validator = jsonschema.Draft202012Validator(schema=self.estimator_schema)

    def test_basic_result(self):
        result_str = '{"results": [{"data": {"evs": 1.1142546245919478, "stds": 0.012101383035893986, "ensemble_standard_error": 0.012101383035893986}, "metadata": {"shots": 4096, "target_precision": 0.015625, "circuit_metadata": {}, "resilience": {}, "num_randomizations": 32}}], "metadata": {"dynamical_decoupling": {"enable": false, "sequence_type": "XX", "extra_slack_distribution": "middle", "scheduling_method": "alap"}, "twirling": {"enable_gates": false, "enable_measure": true, "num_randomizations": "auto", "shots_per_randomization": "auto", "interleave_randomizations": true, "strategy": "active-accum"}, "resilience": {"measure_mitigation": true, "zne_mitigation": false, "pec_mitigation": false}, "version": 2}}'
...
class TestSamplerV2ResultSchema(unittest.TestCase):
    ...
    def test_basic_result(self):
        result_str = '{"results": [{"data": {"meas": {"samples": ["0x3", "0x3", "0x3", "0x3", "0x3"], "num_bits": 2}}, "metadata": {"circuit_metadata": {}}}], "metadata": {"version": 2}}'
        result = json.loads(result_str)
        print(result)
        self.validator.validate(result)