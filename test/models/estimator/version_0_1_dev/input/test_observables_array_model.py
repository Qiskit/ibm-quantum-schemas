...
from ibm_quantum_schemas.models.estimator.version_0_1_dev.input.observables_array_model import (
    ObservableModel,
...
class TestObservablesArrayModelValidation:
    ...
    def test_list_of_observables_same_length(self):
        ...
        assert obs_array.root[0].root == {"XI": 1.0, "YZ": 2.0}
        assert obs_array.root[1].root == {"ZZ": 3.0, "XY": 4.0}
    ...
    def test_list_with_single_observable(self):
        ...
        assert obs_array.root[0].root == {"XX": 1.0}
    ...
    def test_list_with_empty_observables(self):
        ...
        assert isinstance(obs_array.root, list)
        assert len(obs_array.root) == 2
        assert obs_array.root[0].root == {}
        assert obs_array.root[1].root == {}
    ...
    def test_mixed_empty_and_non_empty_observables_same_length(self):
        ...
        assert len(obs_array.root) == 2
        assert obs_array.root[0].root == {}
        assert obs_array.root[1].root == {"XX": 1.0, "YY": 2.0}
    ...
    def test_complex_valid_case(self):
        ...
        assert obs_array.root[0].root == {"IXYZ": 1.0, "ZZII": 2.0}
        assert obs_array.root[1].root == {"XXXX": 3.0}
        assert obs_array.root[2].root == {"YYYY": 4.0, "ZZZZ": 5.0, "IIII": 6.0}
